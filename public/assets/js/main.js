...
(function ($) {
    ...
    CRUMINA.Bootstrap = function () {
        ...
        setDatepiker($('input[name="datetimepicker"]'));


        setDatepiker($('#datetimepicker_start_date'));
        setDatepiker($('#datetimepicker_end_date'));
        setDatepiker($('.kkkk'));
        setDatepiker($('.year_of_graduation'));
        setDatepiker($('.year_of_admission'));
        setDatepiker($('#start_year'));
        setDatepiker($('#end_year'));

        setDatepiker($('#date_of_birth'));
