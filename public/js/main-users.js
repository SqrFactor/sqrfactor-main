            ...
            if (snapshot.numChildren() > 0) {
                ...
                snapshot.forEach(function (childSnapshot) {
                    ...
                    if (data.type == "comment" || data.type == 'like_post' || data.type == "comment_like") {
                        var html = '<li style="cursor:default;"><div class="media"><img class="author-thumb" src="' + base_url + 'profile-picture/' + data.from_user.username + '" alt="author"><div class="media-body"><div class="notification-event"><div><a href="' + base_url + '/profile/detail/' + data.from_user.username + '" class="h6 notification-friend">' + data.from_user.name + '</a> ' + data.body + ' <a href="' + base_url + 'post/post-detail/' + data.post.slug + '" class="notification-link">' + data.post.type + '</a></div><span class="notification-date"><time class="entry-date updated">' + timeDifference(new Date().getTime(), data.created_at) + '</time></span></div><div class="more"><svg class="olymp-little-delete"><use xlink:href="../assets/icons/icons.svg#olymp-little-delete"></use></svg></div></div></div></li>';
                    } else if (data.type == "follow") {
                        var html = '<li style="cursor:default;"><div class="media"><img class="author-thumb" src="' + base_url + 'profile-picture/' + data.from_user.username + '" alt="author"><div class="media-body"><div class="notification-event"><div><a href="' + base_url + '/profile/detail/' + data.from_user.username + '" class="h6 notification-friend">' + data.from_user.name + '</a> ' + data.body + ' </div><span class="notification-date"><time class="entry-date updated">' + timeDifference(new Date().getTime(), data.created_at) + '</time></span></div><div class="more"><svg class="olymp-little-delete"><use xlink:href="../assets/icons/icons.svg#olymp-little-delete"></use></svg></div></div></div></li>';
                    } else if (data.type == "portfolio") {
                        var html = '<li style="cursor:default;"><div class="media"><img class="author-thumb" src="' + base_url + 'profile-picture/' + data.from_user.username + '" alt="author"><div class="media-body"><div class="notification-event"><div><a href="' + base_url + '/profile/detail/' + data.from_user.username + '" class="h6 notification-friend">' + data.from_user.name + '</a> ' + data.body + ' <a href="' + base_url + 'portfolio/' + data.from_user.username + '" class="notification-link">' + data.post.type + '</a></div><span class="notification-date"><time class="entry-date updated">' + timeDifference(new Date().getTime(), data.created_at) + '</time></span></div><div class="more"><svg class="olymp-little-delete"><use xlink:href="../assets/icons/icons.svg#olymp-little-delete"></use></svg></div></div></div></li>';
                    }
