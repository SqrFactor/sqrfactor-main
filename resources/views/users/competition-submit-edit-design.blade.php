...
@section('content')
    ...
    <div class="container" id="page_scroll_up">
        <div class="design-post" id="design-post-1">
            ...
            <form enctype="multipart/form-data" id="competition_submit_design_edit" >
                {{ csrf_field() }}
               <input type="hidden" name="submission_id" value="{{$submission->id}}"/>
                ...
                <input type="hidden" name="cover_image" value="{{$submission->cover}}">
                <input type="hidden" name="pdf_image" value="{{$submission->pdf}}">
                <div class="pl-lg-5">
                    <div class="form-group post_type">
                        <input type="text" placeholder="Design Title" name="design_title"
                               class="form-control" value="{{$submission->title}}" />
                    </div>
                </div>
                ...
                <div class="pl-lg-5">
                    <div class="form-group post_type">
                        ...
                        <img src="{{asset($submission->cover)}}">
                    </div>
                </div>
                ...
                <div class="pl-lg-5" id="design_editor">
                    <div class="form-group" style="margin-left: -13px;">
                        ...
                        <div class="editable" id="design_body"> @if(!empty($submission->body) && $submission->body != null) {!! $submission->body !!}   @endif</div>
